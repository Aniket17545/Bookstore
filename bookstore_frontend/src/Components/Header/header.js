        ...
        <div>
            ...
            <nav className="navbar navbar-expand-lg bg-body-tertiary header">
                <div className="container-fluid header">
                    ...
                    <a class="navbar-brand ms-5 ps-5 brand" href="" onClick={() => navigate("/")}>
                    ...
                    <div className="collapse navbar-collapse " id="navbarSupportedContent">
                        ...
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0 navItem">
                            <li className="nav-item">
                                <a className="nav-link active" aria-current="page" href="" onClick={() => navigate("/about")} style={{ color: "#ffffff" }}>Abouts</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link active" aria-current="page" href="" onClick={() => navigate("/")} style={{ color: "#ffffff" }}>Home</a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="" onClick={() => navigate("/books")} style={{ color: "#ffffff" }}>Books</a>
                            </li>
                            ...
                            <li className="nav-item">
                                <a className="nav-link navIcon" href="" onClick={() => navigate("/cart")}>
